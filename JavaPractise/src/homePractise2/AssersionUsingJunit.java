...
public class AssersionUsingJunit {
...
WebDriver oBrowser;
	...
	public void eVerification()
	{
		...
		Assert.assertTrue("Fail,Displayed amount is words is correct", sExpectedtextLA.equals(sActualtextLA));
		System.out.println("Pass , Displayed amount is words is correct");
          ...
          Assert.assertTrue("Fail,Displayed EMI is not correct", ActualEMI.equals(ExpectedEMI));
          System.out.println("Pass, Displayed EMI is correct");
